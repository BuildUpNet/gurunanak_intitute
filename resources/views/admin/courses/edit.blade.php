...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/admin/admin-courses-edit.css') }}">
@endsection
...
@section('content')
        ...
        <form action="{{ route('admin.courses.update', $course->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text" name="badge" value="{{ old('badge', $course->badge) }}"
                        class="form-control custom-input" placeholder="Popular Course">
                </div>

                <div class="col-md-12 mb-4">
                    <label class="form-label">Short Description</label>
                    <textarea name="short_description" class="form-control custom-textarea" rows="3">{{ old('short_description', $course->short_description) }}</textarea>
                </div>

                <div class="col-md-12 mb-4">
                    <label class="form-label">Quote</label>
                    <input type="text" name="quote" value="{{ old('quote', $course->quote) }}"
                        class="form-control custom-input" placeholder="Your future in healthcare starts here">
                </div>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <input type="text" name="eligibility" value="{{ old('eligibility', $course->eligibility) }}"
                        class="form-control custom-input" placeholder="10+2">
                </div>

                <div class="col-md-4 mb-4">
                    <label class="form-label">Recognition</label>
                    <input type="text" name="recognition" value="{{ old('recognition', $course->recognition) }}"
                        class="form-control custom-input" placeholder="Recognized Program">
                </div>

                <div class="col-md-4 mb-4">
                    <label class="form-label">Placement Rate</label>
                    <input type="text" name="placement_rate"
                        value="{{ old('placement_rate', $course->placement_rate) }}" class="form-control custom-input"
                        placeholder="100%">
                </div>

                <div class="col-md-12 mb-4">
                    <label class="form-label">Program Overview</label>
                    <textarea name="program_overview" class="form-control custom-textarea" rows="5">{{ old('program_overview', $course->program_overview) }}</textarea>
                </div>

                <div class="col-md-12 mb-4">
                    <label class="form-label">About Course</label>
                    <textarea name="about_course" class="form-control custom-textarea" rows="5">{{ old('about_course', $course->about_course) }}</textarea>
                </div>
            ...
            <div class="mb-4">
                ...
                <div id="employmentWrapper">
                    @forelse ($course->employmentOpportunities as $item)
                        <div class="input-group mb-2">
                            <input type="text" name="employment_opportunities[]" value="{{ $item->title }}"
                ...
                <button type="button" class="btn add-btn mt-2 addEmployment">
            ...
            <div class="mb-4">
                ...
                <div id="careerWrapper">
                    @forelse ($course->careerRoles as $item)
                        <div class="input-group mb-2">
                            <input type="text" name="career_roles[]" value="{{ $item->title }}"
                                class="form-control custom-input">
                ...
                <button type="button" class="btn add-btn mt-2 addCareer">
                    <i class="fas fa-plus"></i> Add Career Role
                </button>
            </div>
            ...
            <div class="mb-4">
                ...
                <div id="graduateWrapper">
                    @forelse ($course->graduatesWork as $item)
                        <div class="input-group mb-2">
                            <input type="text" name="graduates_work[]" value="{{ $item->title }}"
                                class="form-control custom-input">
                    ...
                    @empty
                        <div class="input-group mb-2">
                            <input type="text" name="graduates_work[]" class="form-control custom-input"
                                placeholder="Graduate Work Place">
                ...
                <button type="button" class="btn add-btn mt-2 addGraduate">
                    <i class="fas fa-plus"></i> Add Graduate Work
                </button>
            </div>
            ...
            <div class="mb-4">
                ...
                <div id="faqWrapper">
                    @forelse ($course->faqs as $key => $faq)
                        <div class="faq-box mb-3">
                            <input type="text" name="faqs[{{ $key }}][question]"
                                value="{{ $faq->question }}" class="form-control custom-input mb-2"
                                placeholder="Question">

                            <textarea name="faqs[{{ $key }}][answer]" class="form-control custom-textarea" rows="3"
    ...
    <script>
        ...
        let faqIndex = {{ $course->faqs->count() ? $course->faqs->count() : 1 }};
