...
@section('styles')
<link rel="stylesheet" href="{{ asset('css/admin/admin-contact-enquiries-index.css') }}">
@endsection
...
<div class="panel-card mb-3 admin-filter-bar">
    <form method="GET" class="row g-2 align-items-center">
        ...
        <div class="col-md-3 d-flex gap-2">
            ...
            <a href="{{ route('admin.contact-enquiries.index') }}" class="btn btn-outline-secondary">Reset</a>
        </div>
    </form>
</div>
...
<div class="panel-card">
    <div class="table-responsive">
        <table class="table align-middle enquiry-table">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Student</th>
            ...
            <tbody>
                @forelse($enquiries as $key => $enquiry)
                    <tr class="enquiry-row"
                        ...
                        data-bs-target="#enquiryDetail{{ $enquiry->id }}"
                        ...
                        <td>
                            <span class="course-badge">
                                {{ $enquiry->course->title ?? ($enquiry->course ?? '-') }}
                            </span>
                        </td>
                    ...
                    <tr class="collapse" id="enquiryDetail{{ $enquiry->id }}">
                        <td colspan="7">
                            <div class="enquiry-detail-box">
                                <div class="detail-grid">
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-value">{{ $enquiry->course->title ?? ($enquiry->course ?? '-') }}</div>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.enquiry-row').forEach(function(row){
