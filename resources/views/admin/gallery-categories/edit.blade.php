...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/admin/admin-gallery-categories-edit.css') }}">
@endsection

@section('content')
<div class="page-title mb-4">
    <h2>Edit Gallery Category</h2>
    <p>Update gallery category details</p>
</div>

<div class="panel-card category-card">
    <form action="{{ route('admin.gallery-categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                ...
                <label for="imageInput" class="upload-box">
                    <div class="upload-preview {{ $category->image ? 'd-none' : '' }}" id="previewBox">
                    ...
                    <img id="imagePreview"
                         ...
                         class="preview-image {{ $category->image ? '' : 'd-none' }}"
