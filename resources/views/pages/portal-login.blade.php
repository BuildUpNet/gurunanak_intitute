...
@section('meta_description', 'Access GNIMT portal — Student, Admin, Branch and Staff login for Guru Nanak Institute of
    Medical Technology.')
...
@section('content')
    <div class="login-page">
        ...
        <div class="lp-left">
            ...
            <div class="lp-logo">
                <img src="{{ asset('images/logo.png') }}" alt="GNIMT Logo">
            ...
            <div class="lp-info">
                ...
                <div class="lp-info-item">
                    ...
                    <span>Support: <a href="tel:8283929908"
                            style="color:rgba(255,255,255,.75);text-decoration:none;">+91-8283929908</a></span>
                </div>
            </div>
        ...
        <div class="lp-right">
            <div class="lp-right-inner">
                ...
                <p class="lp-right-sub">Access your respective portal below. Each section has dedicated tools, resources and
                    records.</p>

                <div class="lp-options">

                    <a href="https://portal.gurunanakinstitute.com/student/login" class="lp-option-card" target="_blank"
                        rel="noopener">
                    ...
                    <a href="https://portal.gurunanakinstitute.com/portal/login" class="lp-option-card" target="_blank"
                        rel="noopener">
                        <div class="lp-opt-icon">
                    ...
                    <a href="https://portal.gurunanakinstitute.com/branch/login" class="lp-option-card" target="_blank"
                        rel="noopener">
                        <div class="lp-opt-icon">
                    ...
                    <a href="https://portal.gurunanakinstitute.com/branch/staff/login" class="lp-option-card"
                ...
                <p class="lp-footer-note">
                    ...
                    or call <a href="tel:8283929908">+91-8283929908</a> (Patiala) &nbsp;/&nbsp; <a
                        href="tel:8150019000">+91-8150019000</a> (Karnal)
                </p>
            </div>
        </div>
